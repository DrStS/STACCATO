...
IF (NOT MKLROOT_DIR)
   ...
   IF (CMAKE_SYSTEM_NAME MATCHES "Windows")
       IF (EXISTS "C:/Program\ Files\ (x86)/IntelSWTools/parallel_studio_xe_2017/compilers_and_libraries_2017/windows/mkl")
          set(MKLROOT_DIR "C:/Program\ Files\ (x86)/IntelSWTools/parallel_studio_xe_2017/compilers_and_libraries_2017/windows/mkl")
       ENDIF()
   ENDIF()
ENDIF ()
...
if (MKL_LIB_DIR)
  ...
  find_library(MKL_INTEL_THREAD_LIBRARY   mkl_sequential     ${MKL_LIB_DIR})
