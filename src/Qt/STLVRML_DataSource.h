...
#ifndef _STLVRML_DataSource_HeaderFile
#define _STLVRML_DataSource_HeaderFile
...
class STLVRML_DataSource;
DEFINE_STANDARD_HANDLE(STLVRML_DataSource, MeshVS_DataSource)

//! The sample DataSource for working with STLMesh_Mesh
class STLVRML_DataSource : public MeshVS_DataSource
{
...
public:
  ...
  //! Constructor
  Standard_EXPORT STLVRML_DataSource(const Handle(StlMesh_Mesh)& aMesh);
  ...
  DEFINE_STANDARD_RTTIEXT(STLVRML_DataSource,MeshVS_DataSource)
...
#endif // _STLVRML_DataSource_HeaderFile
