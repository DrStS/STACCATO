...
DEFINE_STANDARD_HANDLE(HMeshToMeshVS_DataSource, MeshVS_DataSource)

class HMesh;

//! The sample DataSource3D for working with STLMesh_Mesh
class HMeshToMeshVS_DataSource : public MeshVS_DataSource
{
...
public:
  ...
  //! Constructor
  Standard_EXPORT HMeshToMeshVS_DataSource(HMesh& _HMesh);
...
//DEFINE_STANDARD_RTTIEXT(HMeshToMeshVS_DataSource,MeshVS_DataSource)
