...
void StartWindow::createActions(void)
{
	...
	mReadSTLAction->setIcon(QIcon(":/Qt/resources/fuse.png"));
	mReadSTLAction->setStatusTip(tr("Read STL"));
...
void StartWindow::readSTL()
{
	...
	myOccView->getContext()->Display(aMesh);
