...
IMPLEMENT_STANDARD_RTTIEXT(STLVRML_DataSource,MeshVS_DataSource)

//================================================================
// Function : Constructor
// Purpose  :
//================================================================
STLVRML_DataSource::STLVRML_DataSource( const Handle( StlMesh_Mesh )& aMesh )
{
  myMesh = aMesh;
...
// Purpose  :
//================================================================
Standard_Boolean STLVRML_DataSource::GetGeom
...
// Purpose  :
//================================================================
Standard_Boolean STLVRML_DataSource::GetGeomType
...
// Purpose  :
//================================================================
Standard_Address STLVRML_DataSource::GetAddr
...
// Purpose  :
//================================================================
Standard_Boolean STLVRML_DataSource::GetNodesByElement
...
// Purpose  :
//================================================================
const TColStd_PackedMapOfInteger& STLVRML_DataSource::GetAllNodes() const
{
  return myNodes;
}
...
// Purpose  :
//================================================================
const TColStd_PackedMapOfInteger& STLVRML_DataSource::GetAllElements() const
{
  return myElements;
}
...
// Purpose  :
//================================================================
Standard_Boolean STLVRML_DataSource::GetNormal
