...
IF (NOT OCCTROOT_DIR)
   ...
   IF (CMAKE_SYSTEM_NAME MATCHES "Windows")
       ...
       ENDIF()
	   IF (EXISTS "C:/software/libs/OpenCASCADE6.9.1-vc12-64/opencascade-6.9.1")
          set(OCCTROOT_DIR "C:/software/libs/OpenCASCADE6.9.1-vc12-64/opencascade-6.9.1")
       ENDIF()
   ENDIF()
ENDIF ()
...
find_library(OCCT_LIBRARY_TKXSDRAW          TKXSDRAW                        ${OCCT_LIB_DIR})
  ...
  IF(CMAKE_SYSTEM_NAME MATCHES "Linux")
    set (OCCT_LIBRARIES  ${OCCT_LIBRARY_FWOSPlugin} ${OCCT_LIBRARY_TKBin} ${OCCT_LIBRARY_TKBinL} ${OCCT_LIBRARY_TKBinTObj} ${OCCT_LIBRARY_TKBinXCAF} ${OCCT_LIBRARY_TKBO} ${OCCT_LIBRARY_TKBool} ${OCCT_LIBRARY_TKBRep} ${OCCT_LIBRARY_TKCAF} ${OCCT_LIBRARY_TKCDF}  ${OCCT_LIBRARY_TKDCAF} ${OCCT_LIBRARY_TKDraw} ${OCCT_LIBRARY_TKernel} ${OCCT_LIBRARY_TKFeat} ${OCCT_LIBRARY_TKFillet} ${OCCT_LIBRARY_TKG2d} ${OCCT_LIBRARY_TKG3d} ${OCCT_LIBRARY_TKGeomAlgo} ${OCCT_LIBRARY_TKGeomBase} ${OCCT_LIBRARY_TKHLR} ${OCCT_LIBRARY_TKIGES}  ${OCCT_LIBRARY_TKLCAF} ${OCCT_LIBRARY_TKMath} ${OCCT_LIBRARY_TKMesh} ${OCCT_LIBRARY_TKMeshVS} ${OCCT_LIBRARY_TKOffset} ${OCCT_LIBRARY_TKOpenGl} ${OCCT_LIBRARY_TKPrim} ${OCCT_LIBRARY_TKQADraw} ${OCCT_LIBRARY_TKService} ${OCCT_LIBRARY_TKShHealing} ${OCCT_LIBRARY_TKStd} ${OCCT_LIBRARY_TKStdL} ${OCCT_LIBRARY_TKSTEP} ${OCCT_LIBRARY_TKSTEP209} ${OCCT_LIBRARY_TKSTEPAttr} ${OCCT_LIBRARY_TKSTEPBase} ${OCCT_LIBRARY_TKSTL} ${OCCT_LIBRARY_TKTObj} ${OCCT_LIBRARY_TKTObjDRAW} ${OCCT_LIBRARY_TKTopAlgo} ${OCCT_LIBRARY_TKTopTest} ${OCCT_LIBRARY_TKV3d} ${OCCT_LIBRARY_TKVCAF} ${OCCT_LIBRARY_TKViewerTest} ${OCCT_LIBRARY_TKVRML} ${OCCT_LIBRARY_TKXCAF} ${OCCT_LIBRARY_TKXDEDRAW} ${OCCT_LIBRARY_TKXDEIGES} ${OCCT_LIBRARY_TKXDESTEP} ${OCCT_LIBRARY_TKXMesh} ${OCCT_LIBRARY_TKXml} ${OCCT_LIBRARY_TKXmlL} ${OCCT_LIBRARY_TKXmlTObj} ${OCCT_LIBRARY_TKXmlXCAF} ${OCCT_LIBRARY_TKXSBase} ${OCCT_LIBRARY_TKXSDRAW})
  ELSEIF (CMAKE_SYSTEM_NAME MATCHES "Windows")
    set (OCCT_LIBRARIES  ${OCCT_LIBRARY_FWOSPlugin} ${OCCT_LIBRARY_TKBin} ${OCCT_LIBRARY_TKBinL} ${OCCT_LIBRARY_TKBinTObj} ${OCCT_LIBRARY_TKBinXCAF} ${OCCT_LIBRARY_TKBO} ${OCCT_LIBRARY_TKBool} ${OCCT_LIBRARY_TKBRep} ${OCCT_LIBRARY_TKCAF} ${OCCT_LIBRARY_TKCDF} ${OCCT_LIBRARY_TKD3DHost} ${OCCT_LIBRARY_TKDCAF} ${OCCT_LIBRARY_TKDraw} ${OCCT_LIBRARY_TKernel} ${OCCT_LIBRARY_TKFeat} ${OCCT_LIBRARY_TKFillet} ${OCCT_LIBRARY_TKG2d} ${OCCT_LIBRARY_TKG3d} ${OCCT_LIBRARY_TKGeomAlgo} ${OCCT_LIBRARY_TKGeomBase} ${OCCT_LIBRARY_TKHLR} ${OCCT_LIBRARY_TKIGES} ${OCCT_LIBRARY_TKIVtk} ${OCCT_LIBRARY_TKIVtkDraw} ${OCCT_LIBRARY_TKLCAF} ${OCCT_LIBRARY_TKMath} ${OCCT_LIBRARY_TKMesh} ${OCCT_LIBRARY_TKMeshVS} ${OCCT_LIBRARY_TKOffset} ${OCCT_LIBRARY_TKOpenGl} ${OCCT_LIBRARY_TKPrim} ${OCCT_LIBRARY_TKQADraw} ${OCCT_LIBRARY_TKService} ${OCCT_LIBRARY_TKShHealing} ${OCCT_LIBRARY_TKStd} ${OCCT_LIBRARY_TKStdL} ${OCCT_LIBRARY_TKSTEP} ${OCCT_LIBRARY_TKSTEP209} ${OCCT_LIBRARY_TKSTEPAttr} ${OCCT_LIBRARY_TKSTEPBase} ${OCCT_LIBRARY_TKSTL} ${OCCT_LIBRARY_TKTObj} ${OCCT_LIBRARY_TKTObjDRAW} ${OCCT_LIBRARY_TKTopAlgo} ${OCCT_LIBRARY_TKTopTest} ${OCCT_LIBRARY_TKV3d} ${OCCT_LIBRARY_TKVCAF} ${OCCT_LIBRARY_TKViewerTest} ${OCCT_LIBRARY_TKVRML} ${OCCT_LIBRARY_TKXCAF} ${OCCT_LIBRARY_TKXDEDRAW} ${OCCT_LIBRARY_TKXDEIGES} ${OCCT_LIBRARY_TKXDESTEP} ${OCCT_LIBRARY_TKXMesh} ${OCCT_LIBRARY_TKXml} ${OCCT_LIBRARY_TKXmlL} ${OCCT_LIBRARY_TKXmlTObj} ${OCCT_LIBRARY_TKXmlXCAF} ${OCCT_LIBRARY_TKXSBase} ${OCCT_LIBRARY_TKXSDRAW})
  ELSE()
    set (OCCT_LIBRARIES "")
  ENDIF()
ENDIF()
